...
/**modify by suicy 2018-01-18 add async param**/
$.ajax({type:opts.method,url:opts.href,async:(opts.loadAsync!=undefined?opts.loadAsync:true),cache:false,data:_273,dataType:"html",success:function(data){
_274(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,data:_aa8,async:false,dataType:"json",success:function(data){
_aa9(data);
},error:function(){
